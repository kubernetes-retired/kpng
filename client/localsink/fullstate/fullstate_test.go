...
var syncOp = &localv1.OpItem{Op: &localv1.OpItem_Sync{Sync: &localv1.EmptyOp{}}}
...
func TestAddRemoveService(t *testing.T) {
	...
	svcRef := &localv1.Ref{
		Set:  localv1.Set_ServicesSet,
		Path: "test/nginx",
	}
	svcBytes, _ := proto.Marshal(&localv1.Service{
		Namespace: "test",
		Name:      "nginx",
	})

	sink.Send(&localv1.OpItem{
